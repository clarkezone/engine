...
#ifndef FLUTTER_SHELL_PLATFORM_WINDOWS_CLIENT_WRAPPER_INCLUDE_FLUTTER_DART_PROJECT_WINRT_H_
#define FLUTTER_SHELL_PLATFORM_WINDOWS_CLIENT_WRAPPER_INCLUDE_FLUTTER_DART_PROJECT_WINRT_H_
...
class DartProjectWinRT {
 public:
  ...
  // the running executable.
    explicit DartProjectWinRT(const std::wstring& assetspath,
 ...
 private:
  ...
  // them.
  friend class FlutterEngineWinRT;
...
#endif  // FLUTTER_SHELL_PLATFORM_WINDOWS_CLIENT_WRAPPER_INCLUDE_FLUTTER_DART_PROJECT_WINRT_H_
