...
vars = {
  ...
  'dart_revision': 'd3320177ee9afb2decf20872ac00a3117db0c8be',
     ...
     'packages': [
       {
        ...
        'version': 'kLoBz4ZY4F3tJks9_M4HlTB0ZHIAJyDDuqQAzy6R22QC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'Idk0D_EZk23zZWzrluF8-59ADiad9-8ypAPpR-ki148C'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
