...
vars = {
  ...
  'skia_revision': 'cdd852b579482f9110d83ab40503b413f1d4131f',
    ...
    'packages': [
      {
        ...
        'version': 'CafIgcePdmsvoLP2WSv9CJFPbACkB84C4VmOgGtZrDgC' 
      }
    ],
     ...
     'packages': [
       {
        ...
        'version': '2R0Qlyol4TuGAWoqcCFDGaEe1YEHOFNjJUxintczw5EC'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'fyXNImnNHOh00YEBE0Pxu7r-Uh122cYghHufjPvxwZQC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
