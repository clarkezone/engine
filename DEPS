...
vars = {
  ...
  'skia_revision': 'a298431a13705b80b282f84eb8435a3a0118dbea',
  ...
  'dart_revision': 'd7266520ca1816fe3ec061077febb8c5d6849f94',
...
deps = {
  ...
  'src': 'https://github.com/clarkezone/buildroot.git' + '@' + 'dc85f9c1b3943d266bf2b128df95faeadc13c9f1',
  ...
  'src/third_party/skia':
   ...
   Var('github_git') + '/clarkezone/skia.git' + '@' + '4a01f564dc2abcb0fa75c0ff08b3c1690eec82ed',
     ...
     'packages': [
       {
        ...
        'version': 'n0XovQHCzNWivo3nRJxzE2kfDTP40DhEcBZyfjJ9SqQC'
       }
     ],
     ...
     'packages': [
       {
        ...
        'version': '5Rxyho8VLJtgVAEUp7KLAlQweNmec4Y4y0ho93VR-k4C'
       }
     ],
