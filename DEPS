...
vars = {
  ...
  'skia_revision': '8eb119af466bc0d9b39483953bd42fe428368a19',
     ...
     'packages': [
       {
        ...
        'version': '03qqGegOAY4ja9l1XFHNM2t_ykihSBiz9TE2rNiYUC0C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'f1YmNNwFe_k0ssxY1oEbRmTh6RPdgpJtWv5GyTRJjrEC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
