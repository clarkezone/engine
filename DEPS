...
vars = {
  ...
  'skia_revision': '202420e0147b02f963de761a903b2c430dfa0cec',
     ...
     'packages': [
       {
        ...
        'version': 'eWFcsfSTfbzQY62hkl4yExs7HjSkBVE8K3mU1UxGZK0C'
       }
     ],
     'condition': 'host_os == "mac"',
     'dep_type': 'cipd',
     ...
     'packages': [
       {
        ...
        'version': 'oOI7Iq5ERZ3jUqPJH9CRvrOM5RA4N1dxCimLkdDbX9wC'
       }
     ],
     'condition': 'host_os == "linux"',
     'dep_type': 'cipd',
