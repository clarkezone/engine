...
vars = {
  ...
  'skia_revision': '8cc118dce81392f94da2a05de41a48fb34f54b1f',
  ...
  'dart_revision': 'bd528bfbd69deecd3e8ad21e634da495bf0c09bb',
...
deps = {
  ...
  'src/third_party/dart':
   # Var('dart_git') + '/sdk.git' + '@' + Var('dart_revision'),
    'https://github.com/clarkezone/sdk.git' + '@' + '3910d29ca45c37d5aa12a812601610631e9b007e',
     ...
     'packages': [
       {
        ...
        'version': 'd_5wDVmBdmLoZFwim5qFY4G9xXel2vAMP6s_DY65ulsC'
       }
     ],
